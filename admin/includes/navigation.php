            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                     ...
                     <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#show_posts"><i class="fa fa-fw fa-edit"></i> Post <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="show_posts" class="collapse">
                            <li>
